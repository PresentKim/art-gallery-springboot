...
public interface MemberRepository extends JpaRepository<MemberEntity, String> {
    ...
    Slice<MemberEntity> findAllByNameContainingIgnoreCaseOrIdContainingIgnoreCase(String name, String id, Pageable pageable);

    long countAllByNameContainingIgnoreCaseOrIdContainingIgnoreCase(String name, String id);
