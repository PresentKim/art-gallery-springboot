 ...
 * </pre></blockquote>
 * <p>
 * 어노테이션의 {@link #value}를 설정해 이동시킬 URL을 지정할 수 있고, 설정하지 않으면 페이지 이동을 하지 않습니다.
 ...
 * {@link NotLoginException#getReturnUrl}에는 {@link CheckLogin}의 {@link #value}로 설정한 URL이 저장됩니다.
 * <p>
