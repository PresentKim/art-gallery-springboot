...
/**
 * {@link RestController} 어노테이션이 달린 클래스의 메소드,
 * {@link ResponseBody} 어노테이션이 달린 메소드의 응답,
 * {@link ExceptionHandler} 어노테이션이 달린 메소드의 응답을 {@link ResponseDto} 객체로 감싸 반환하는 Aspect 클래스
 *
...
public class RestResponseWrapperAspect {
     ...
     * {@link RestController} 어노테이션이 달린 클래스의 메소드,
     * {@link ResponseBody} 어노테이션이 달린 메소드의 응답,
     * {@link ExceptionHandler} 어노테이션이 달린 메소드의 응답을 {@link ResponseDto} 객체로 감싸 반환합니다.
     *
