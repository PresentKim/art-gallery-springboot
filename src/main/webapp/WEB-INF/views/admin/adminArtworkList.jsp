    ...
    <form name="adminForm" method="get" action="<c:url value="/admin/artwork"/>" onsubmit="ajaxSubmit(event)">
        <div class="admin-list-btn">
            ...
            <div class="admin-list-func-btn">
                ...
                <input type="submit" value="수정" formmethod="post" formaction="<c:url value="/admin/artwork/updates"/>">
                <input type="submit" value="삭제" formmethod="post" formaction="<c:url value="/artwork/delete"/>">
            </div>
