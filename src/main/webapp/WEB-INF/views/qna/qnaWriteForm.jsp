...
<main class="qna-write">
    ...
    <form class="qna-write_body" action="museum.do?command=qnaWrite" method="post" onsubmit="ajaxSubmit(event)">
        ...
        <div class="qna-write_input-wrapper">
            ...
            <input name="title" type="text" maxlength="100" autocomplete="off" value="${qnaDto.title}" placeholder=" "
                   required/>
        ...
        <div class="qna-write_input-wrapper">
            ...
            <input name="pwd" type="password" maxlength="45" autocomplete="off" value="${qnaDto.pwd}" placeholder=" "
                   required/>
            <label for="pwd">글 비밀번호</label>
        </div>
        <div class="qna-write_input-wrapper">
            <i class="qna-icon email"></i>
            <input name="email" type="email" maxlength="45" autocomplete="email" value="${qnaDto.email}" placeholder=" "
                   required/>
            <label for="email">작성자 이메일</label>
        </div>
        <div class="qna-write_input-wrapper">
            <i class="qna-icon phone"></i>
            <input name="phone" type="tel" maxlength="45" autocomplete="tel" value="${qnaDto.phone}" placeholder=" "
                   required/>
        ...
        <div class="qna-write_input-wrapper">
            ...
            <textarea name="content" placeholder=" " required
                      oninput="this.parentNode.dataset.textareaInput = this.value">${qnaDto.content}</textarea>
